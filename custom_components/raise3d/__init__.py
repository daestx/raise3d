...
from homeassistant.const import CONF_NAME, CONF_HOST, CONF_SCAN_INTERVAL, Platform
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    hass.data[DOMAIN][entry.entry_id] = coordinator = Raise3dDataUpdateCoordinator(
        hass=hass,
